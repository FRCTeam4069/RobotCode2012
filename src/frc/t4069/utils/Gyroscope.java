 ...
 */
public class Gyroscope extends SensorBase implements PIDSource, ISensor {

	static final int kOversampleBits = 10;
	static final int kAverageBits = 0;
	static final double kSamplesPerSecond = 10.0;
	...
	private void initGyro() {
		...
		if (m_analog == null) System.out.println("Null m_analog");
		...
		m_offset = ((double) result.value / (double) result.count) - center;
	 ...
	 */
	public Gyroscope(int slot, int channel) {
	 ...
	 */
	public Gyroscope(AnalogChannel channel) {
		m_analog = channel;
		if (m_analog == null)
			System.err
	 ...
	 */
	public void reset() {
		if (m_analog != null) m_analog.resetAccumulator();
	}
	 ...
	 */
	public void free() {
		if (m_analog != null && m_channelAllocated) m_analog.free();
		m_analog = null;
	}
