...
public class RobotMap {
	...
	public static final int PHOTO_CHANNEL_1 = 4;
	public static final int PHOTO_CHANNEL_2 = 5;
	public static final int PHOTO_CHANNEL_3 = 6;


	public static final int PICKUP_ARM_MOTOR_1 = 1;
	public static final int PICKUP_ARM_MOTOR_2 = 2;
	public static final int PICKUP_SPIN_MOTOR = 3;
}
