...
public class RobotMap {
	...
	public static final int PICKUP_MOTOR = 4;

	public static final int CAMERA_TILT_SERVO = 9;
	public static final int CAMERA_PAN_SERVO = 7;

	// DigitalIO section!
	public static final int BALL_SWITCH_1 = 1;
	public static final int BALL_SWITCH_2 = 2;
	public static final int BALL_SWITCH_3 = 3;
}
